...
# Exercício 01 - Criar página para tela pequena
...
# Exercício 02 - Criando 3 layouts diferentes utilizando o mobile first
...
Obs.: A página acima é uma versão sem estilização do primeiro capítulo do livro Alice no País das Maravilhas.
...
# Exercício 03 - Criando layouts para dispositivos móveis e para impressão
...
Obs.: O objetivo deste exercício é usar media queries para fazer a página acima parecer diferente na hora da impressão e em diferentes tamanhos de tela.
